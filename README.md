...
[Kernel source](https://github.com/Couch-OS/couch-kernel) ·
...
```sh
curl -fsSL https://github.com/Couch-OS/couch-installer/releases/download/installer-v0.2.1/install.sh | sh
```
