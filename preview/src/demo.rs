...
pub fn configure(app: &App) {
    ...
    app.set_show_battery_percentage(false);
    ...
    app.on_setting_battery_percentage_changed(|shown| {
        later(move |_, a| a.set_show_battery_percentage(shown));
    });
    d.borrow()
        .timer
...
pub fn documentation_screen(name: &str) {
    ...
    let _ = slint::invoke_from_event_loop(move || {
        with(|d, a| {
            ...
            a.set_settings_shown(false);
            a.set_settings_panel(0);
            ...
            match name.as_str() {
                ...
                "battery-low" => a.set_battery(19),
                "battery-medium" => a.set_battery(20),
