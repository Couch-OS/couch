...
and writes on/off and level, so the controls show one centred brightness bar,
no colour temperature, and the channel keys do nothing there. The bar is never
highlighted; volume and up/down move it and OK switches the lamp. Activities, scenes and physical
