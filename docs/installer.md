...
Release `v0.1.0-alpha.20260916.166` is published as a prerelease. Its
...
curl --fail --location --proto '=https' --tlsv1.2 \
  https://github.com/dangerouslaser/couch/releases/download/v0.1.0-alpha.20260916.166/install.sh | sh
```

Windows x64, from PowerShell:

```powershell
Invoke-RestMethod 'https://github.com/dangerouslaser/couch/releases/download/v0.1.0-alpha.20260916.166/install.ps1' | Invoke-Expression
```
