...
def run(args):
    ...
    checks = {"v3_protocol_probe": "passed"}
    ...
    receipt = {"schema":1,"kind":"couch-integration-host-compatibility","evidence_level":"host-protocol-compatibility",
        "core":{"source_commit":core,"supported_protocol_versions":[1,2,3],"target":"armv7-unknown-linux-musleabihf","binary_sha256":digest(args.confd)},
